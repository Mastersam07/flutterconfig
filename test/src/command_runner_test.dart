...
import 'package:flutterconfig_cli/src/command_runner.dart';
...
void main() {
  group('FlutterconfigCliCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late FlutterconfigCliCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = FlutterconfigCliCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = FlutterconfigCliCommandRunner();
    ...
    group('--verbose', () {
      ...
      test('enables verbose logging for sub commands', () async {
        ...
        verify(() => logger.detail('  Top level options:')).called(1);
        verify(() => logger.detail('  - verbose: true')).called(1);
        verify(() => logger.detail('  Command: init')).called(1);
